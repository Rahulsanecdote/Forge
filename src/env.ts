...
const schema = z.object({
  ...
  FORGE_ALERT_CRON: optionalConfigSchema,
  FORGE_ALERT_WEBHOOK_URL: optionalConfigSchema,
...
const runtimeEnv = {
  ...
  FORGE_ALERT_CRON: process.env.FORGE_ALERT_CRON,
  FORGE_ALERT_WEBHOOK_URL: process.env.FORGE_ALERT_WEBHOOK_URL,
